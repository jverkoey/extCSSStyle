...
#import "extCSSStyle/TTDefaultCSSStyleSheet.h"

// extCSSStyle
#import "extCSSStyle/TTCSSStyleSheet.h"
...
NSString* kDefaultCSSPath = @"extCSSStyle.bundle/stylesheets/default.css";
...
- (id)init {
  if (self = [super init]) {
    ...
    // If this fails, it's very likely that you forgot to add the extCSSStyle.bundle file
